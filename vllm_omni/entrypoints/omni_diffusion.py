...
class OmniDiffusion:
    ...
    def __init__(self, od_config: OmniDiffusionConfig | None = None, **kwargs):
        ...
        # Inject stage info into omni_config if present
        if stage_id is not None:
            self.od_config.omni_config.setdefault("stage_id", stage_id)
        if engine_input_source is not None:
            self.od_config.omni_config.setdefault("engine_input_source", engine_input_source)
