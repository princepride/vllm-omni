...
async def _stage_worker_async(
    ...
    try:
        if stage_type == "diffusion":
            ...
            if "omni_config" not in od_config:
                od_config["omni_config"] = {}
            od_config["omni_config"]["stage_id"] = stage_id
            od_config["omni_config"]["engine_input_source"] = stage_payload.get("engine_input_source", [])
