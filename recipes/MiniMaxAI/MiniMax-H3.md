...
latent size, so a refine after an upscale enlarges the encoder-stage keyframe
latents with the same upscaler; this avoids loading a second VAE encoder in the
DiT stage. REF2VA references carry their own shapes and are reused as they are.
